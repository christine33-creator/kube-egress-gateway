...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GatewayProfile) DeepCopyInto(out *GatewayProfile) {
	*out = *in
	if in.VmssProfile != nil {
		in, out := &in.VmssProfile, &out.VmssProfile
		*out = new(GatewayVmssProfile)
		**out = **in
	}
	if in.StandaloneVMProfile != nil {
		in, out := &in.StandaloneVMProfile, &out.StandaloneVMProfile
		*out = new(GatewayStandaloneVMProfile)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GatewayProfile.
func (in *GatewayProfile) DeepCopy() *GatewayProfile {
	if in == nil {
		return nil
	}
	out := new(GatewayProfile)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GatewayStandaloneVMProfile) DeepCopyInto(out *GatewayStandaloneVMProfile) {
	*out = *in
	if in.VMNames != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GatewayStandaloneVMProfile.
func (in *GatewayStandaloneVMProfile) DeepCopy() *GatewayStandaloneVMProfile {
	if in == nil {
		return nil
	}
	out := new(GatewayStandaloneVMProfile)
...
func (in *GatewayVMConfigurationSpec) DeepCopyInto(out *GatewayVMConfigurationSpec) {
	*out = *in
	in.GatewayProfile.DeepCopyInto(&out.GatewayProfile)
	out.GatewayVmssProfile = in.GatewayVmssProfile
}
